                                    ...
                                    builder: (context, mapState) {
                                      return Listener(
                                        ...
                                        child: GoogleMap(
                                          ...
                                          padding: _mapPaddingForCamera(
                                            context,
                                          ),
                                          myLocationEnabled:
                                              mockState.hasLocationPermission ==
                                              true,
                                  ...
                                  BlocBuilder<SpooferMapBloc, SpooferMapState>(
                                    builder: (context, mapState) {
                                      ...
                                      final double overlayBottom =
                                          12 +
                                          (controlsVisible ? 0.0 : bottomInset);
